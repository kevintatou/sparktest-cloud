    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">
          Agents run in your infrastructure and execute test runs. Generate a
          token, start the agent, then verify the connection.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center gap-2">
        {STEPS.map((step, i) => {
          ...
          const isComplete =
            i < currentStepIndex || (step.id === 'verify' && connected);
          return (
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  The token authenticates your agent with SparkTest Cloud. Give
          ...
          {currentStep === 'install' && createdToken && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Run the source-based command for now. Container commands will
                  appear here once a public agent image is published.
                </p>
              </div>
